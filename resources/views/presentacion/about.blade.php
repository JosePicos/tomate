    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <h1>Mision:</h1> 
          <p>
          Seremos la primera empresa autosostenible de pequeños productores y productoras agrícolas en la que piense un comprador cuando necesite un producto y servicio de calidad, entregado con responsabilidad. Para todo el sector productivo de Sinaloa.
          </p>
